          ...
          <div className="hud">
            ...
            <div className="player-side">
              { this.props.game.playerOrder.indexOf(this.props.user.id) > -1
                ? <PlayerMount onClick={this.addToMove('chosenPlayer')} userId={this.props.user.id} player={this.props.game.players[this.props.user.id]} selected={this.state.move.chosenPlayer === this.props.user.id} />
                : (
